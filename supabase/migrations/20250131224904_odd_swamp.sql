/*
  ...
  1. Novas Tabelas
    - `quotes`
      - `id` (uuid, primary key)
      - `machine_id` (uuid, referência para machines)
      - `client_id` (uuid, referência para profiles)
      - `landlord_id` (uuid, referência para profiles)
      - `rental_period` (text)
    ...
    - `quote_accessories`
      - `id` (uuid, primary key)
      - `quote_id` (uuid, referência para quotes)
      - `accessory_id` (uuid, referência para accessories)
