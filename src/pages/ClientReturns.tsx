    ...
    try {
      ...
      const transformedReturns = returnsData.map(returnData => ({
        ...
        rental: {
          ...
          landlord: {
            id: returnData.rental.landlord.id,
            name: returnData.rental.landlord.name || returnData.rental.landlord.email,
            email: returnData.rental.landlord.email
          },
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 mt-2">
                  Que tal explorar nosso catálogo de equipamentos?
                </p>
                <a
                  href="/aluguel-de-equipamentos"
                  className="inline-flex items-center mt-4 px-6 py-3 bg-primary text-white rounded-xl hover:bg-primary/90 transition-colors"
                >
                        ...
                        <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
                          <div>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                              Proprietário: {returnItem.rental.landlord.name}
                            </p>
                          </div>
